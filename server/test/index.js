...
describe('API ENDPOINT TESTING', () => {
    ...
    it('POST BOOKING-PAGE', (done) => {
        ...
        const dataSample = {
            ...
            firstName: 'Arif',
            lastName: 'Wibawa',
            emailAddress: 'arif@internet.com',
            phoneNumber: '085362873129',
            accountHolder: 'Arif',
            bankOrigin: 'JAGOO'
        }
        ...
        .field('bankOrigin', dataSample.bankOrigin)
        ...
        .end((err, res) => {
            ...
            expect(res.body.message).to.equal('Booking succeed')
            expect(res.body).to.have.property('booking')
            expect(res.body.booking).to.have.all.keys('payments', '_id', 'invoice', 'startDate', 'endDate', 'total', 'itemId', 'memberId', '__v')
            expect(res.body.booking.payments).to.have.all.keys('status', 'receipt', 'bankOrigin', 'accountHolder')
